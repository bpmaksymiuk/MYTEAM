...
async function restoreState() {
  try {
    ...
    const start = Number.isInteger(notepadState.cursorStart) ? clamp(notepadState.cursorStart, 0, len) : 0;
    const end = Number.isInteger(notepadState.cursorEnd) ? clamp(notepadState.cursorEnd, start, len) : start;
