...
- ID UC-001
- ACTOR End User
- NAME Configure Simulation Workspace
- STEPS
...
- ID UC-002
- ACTOR End User
- NAME Place Positive And Negative Probes
- STEPS
...
- ID UC-004
- ACTOR End User
- NAME Spawn Charges From Negative Probes
- STEPS
...
- ID UC-005
- ACTOR End User
- NAME Move Charges According To Coulomb Physics
- STEPS
...
- ID UC-006
- ACTOR End User
- NAME Annihilate Charges At Positive Probes
- STEPS
...
- ID UC-007
- ACTOR End User
- NAME Tune Runtime Parameters During Simulation
- STEPS
...
- ID UC-008
- ACTOR End User
- NAME Experience Advanced And Intuitive UI
- STEPS
...
- ID UC-009
- ACTOR End User
- NAME Run Entire Experience In Browser
- STEPS
