...
At the end of Stage 9, after all DIs are implemented. Also used when a bug fix re-run completes at Stage 9. Write one RN entry per run — never overwrite prior entries.
