...
At Stage 6, after architecture and parts are approved. Reads `4-REQUIREMENTS.md`, `5-ARCHITECTURE-RECOMMENDATIONS.md`, and `5-PARTS LIST.md` and produces `6-DESIGN-INSTRUCTIONS.md`. Each DI must be complete enough for the Developer to act on immediately.
