...
- **Stage 0:** When drafting proposed use cases from a goal, brief, or stakeholder input. Output goes to `1-USE-CASES-PROPOSED.md` only.
- **Stage 1:** When promoting proposed use cases to the approved intent file. Output goes to `1-USE-CASES.md`.
