...
description: 'Write 6-DESIGN-INSTRUCTIONS.md from requirements and architecture. Use for Stage 6 technical design, implementation-ready DI records, file-by-file steps, function signatures, pseudocode, edge cases, and developer handoff quality.'
...
## When to Use
- Creating or updating PROJECTS/**/6-DESIGN-INSTRUCTIONS.md
- Turning requirements and architecture into implementation-ready steps
- Auditing whether design guidance is detailed enough for Stage 6
