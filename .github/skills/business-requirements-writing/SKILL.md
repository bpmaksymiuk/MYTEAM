...
description: 'Write or update 4-REQUIREMENTS.md from 1-USE-CASES.md. Use for Stage 4 business requirements, atomic BR statements, NASA-style shall language, testable conditions, and UC-to-BR traceability.'
...
## When to Use
- Creating or updating PROJECTS/**/4-REQUIREMENTS.md
- Converting approved use cases into atomic, testable BR records
- Auditing BR quality, traceability, or Stage 4 exit-gate coverage
...
2. Read `1-USE-CASES.md` and `3-CONCEPT-STORYBOARD.md` in full before writing.
